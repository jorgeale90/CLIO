    ...
    $.validationEngineLanguage = {
        newLang: function(){
		    ...
		    "alertTextCheckboxe": "* Assinale a caixa de seleção",
                ...
                "past": {
                    "regex": "none",
                    "alertText": "* Datacion anterior a "
                },
                "future": {
                    "regex": "none",
                    "alertText": "* Datacion posterior a "
                },	
                "maxCheckbox": {
                    "regex": "none",
			...
			"func": function (field) {
			 ...
			 "alertText": "* Datacion inválida, o formato deve de ser AAAA-MM-DD (ex.2012-12-31)"
                },
                "ipv4": {
                ...
                "dateFormat":{
					...
					"alertText": "* Datacion inválida"
                },
                //tls warning:homegrown not fielded 
				"dateTimeFormat": {
	                "regex": /^\d{4}[\/\-](0?[1-9]|1[012])[\/\-](0?[1-9]|[12][0-9]|3[01])\s+(1[012]|0?[1-9]){1}:(0?[1-5]|[0-6][0-9]){1}:(0?[0-6]|[0-6][0-9]){1}\s+(am|pm|AM|PM){1}$|^(?:(?:(?:0?[13578]|1[02])(\/|-)31)|(?:(?:0?[1,3-9]|1[0-2])(\/|-)(?:29|30)))(\/|-)(?:[1-9]\d\d\d|\d[1-9]\d\d|\d\d[1-9]\d|\d\d\d[1-9])$|^((1[012]|0?[1-9]){1}\/(0?[1-9]|[12][0-9]|3[01]){1}\/\d{2,4}\s+(1[012]|0?[1-9]){1}:(0?[1-5]|[0-6][0-9]){1}:(0?[0-6]|[0-6][0-9]){1}\s+(am|pm|AM|PM){1})$/,
					"alertText": "* Datacion inválida ou mal formatada",
