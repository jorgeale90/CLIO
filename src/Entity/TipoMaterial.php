 ...
 * @UniqueEntity(fields={"nombre"}, message="Ya existe este Tipo de Material.")
 * @Auditable()
 */
...
class TipoMaterial
{
    ...
    /**
     * @var string
     * @ORM\Column(name="nombretipomaterial", type="string",  nullable=false, length=100, unique=true)
    ...
    /**
     * @ORM\OneToMany(targetEntity="FichaObjetoPatrimonial", mappedBy="tipomaterial")
     */
    ...
    public function addFichaobjeto(FichaObjetoPatrimonial $fichaobjeto): self
    {
        if (!$this->fichaobjeto->contains($fichaobjeto)) {
            ...
            $fichaobjeto->setTipomaterial($this);
        }
    ...
    public function removeFichaobjeto(FichaObjetoPatrimonial $fichaobjeto): self
    {
        if ($this->fichaobjeto->contains($fichaobjeto)) {
            ...
            if ($fichaobjeto->getTipomaterial() === $this) {
                $fichaobjeto->setTipomaterial(null);
            }
        }
