...
/**
 * @ORM\Entity(repositoryClass="App\Repository\TipoIntervencionRepository")
 * @UniqueEntity(fields={"nombre"}, message="Ya existe este Tipo de Intervención.")
 * @Auditable()
 */
...
class TipoIntervencion
{
    ...
    /**
     * @var string
     * @ORM\Column(name="nombretipointer", type="string",  nullable=false, length=100, unique=true)
    ...
    /**
     * @ORM\OneToMany(targetEntity="App\Entity\Intervencion", mappedBy="tipointervencion")
     */
    ...
    public function removeIntervencion(Intervencion $intervencion): self
    {
        if ($this->intervencion->contains($intervencion)) {
            ...
            if ($intervencion->getTipointervencion() === $this) {
