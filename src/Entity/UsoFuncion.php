...
/**
 * @ORM\Entity(repositoryClass="App\Repository\UsoFuncionRepository")
...
class UsoFuncion
{
    ...
    /**
     * @var string
     * @ORM\Column(name="nombreusofuncion", type="string",  nullable=false, length=100, unique=true)
    ...
    /**
     * @ORM\OneToMany(targetEntity="FichaObjetoPatrimonial", mappedBy="usofuncion")
     */
    ...
    public function addFichaobjeto(FichaObjetoPatrimonial $fichaobjeto): self
    {
        if (!$this->fichaobjeto->contains($fichaobjeto)) {
            ...
            $fichaobjeto->setUsofuncion($this);
        }
    ...
    public function removeFichaobjeto(FichaObjetoPatrimonial $fichaobjeto): self
    {
        if ($this->fichaobjeto->contains($fichaobjeto)) {
            ...
            if ($fichaobjeto->getUsofuncion() === $this) {
                $fichaobjeto->setUsofuncion(null);
            }
        }
