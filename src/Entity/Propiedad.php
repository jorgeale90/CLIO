...
/**
 * @ORM\Entity(repositoryClass="App\Repository\PropiedadRepository")
 * @UniqueEntity(fields={"nombre"}, message="Ya existe esta Profesión.")
 * @Auditable()
 */
...
class Propiedad
{
    ...
    /**
     * @var string
     * @ORM\Column(name="nombrepropiedad", type="string",  nullable=false, length=80, unique=true)
    ...
    /**
     * @ORM\OneToMany(targetEntity="SitioPatrimonial", mappedBy="propiedad")
     */
    ...
    public function addSitiopatrimonial(SitioPatrimonial $sitiopatrimonial): self
    {
        if (!$this->sitiopatrimonial->contains($sitiopatrimonial)) {
            ...
            $sitiopatrimonial->setPropiedad($this);
        }
    ...
    public function removeSitiopatrimonial(SitioPatrimonial $sitiopatrimonial): self
    {
        if ($this->sitiopatrimonial->contains($sitiopatrimonial)) {
            ...
            if ($sitiopatrimonial->getPropiedad() === $this) {
                $sitiopatrimonial->setPropiedad(null);
            }
        }
