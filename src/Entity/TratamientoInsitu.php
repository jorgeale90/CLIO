...
/**
 * @ORM\Entity(repositoryClass="App\Repository\TratamientoInsituRepository")
 * @UniqueEntity(fields={"nombre"}, message="Ya existe este Tratamiento Insitu.")
 * @Auditable()
 */

class TratamientoInsitu
{
    /**
     * @ORM\Id()
     * @ORM\GeneratedValue()
    ...
    /**
     * @var string
     * @ORM\Column(name="nombretrataminsi", type="string",  nullable=false, length=100, unique=true)
    ...
    /**
     * @ORM\OneToMany(targetEntity="IntervencionConservacion", mappedBy="tratamientoinsitu")
     */
    ...
    public function addIntervencionconservacion(IntervencionConservacion $intervencionconservacion): self
    {
        if (!$this->intervencionconservacion->contains($intervencionconservacion)) {
            ...
            $intervencionconservacion->setTratamientoinsitu($this);
        }
    ...
    public function removeIntervencionconservacion(IntervencionConservacion $intervencionconservacion): self
    {
        if ($this->intervencionconservacion->contains($intervencionconservacion)) {
            ...
            if ($intervencionconservacion->getTratamientoinsitu() === $this) {
                $intervencionconservacion->setTratamientoinsitu(null);
            }
        }
