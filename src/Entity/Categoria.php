 ...
 * @UniqueEntity(fields={"nombre"}, message="Ya existe esta Categoría.")
 * @Auditable()
 */
...
class Categoria
{
    ...
    /**
     * @var string
     * @ORM\Column(name="nombrecategoria", type="string",  nullable=false, length=80, unique=true)
    ...
    /**
     * @ORM\OneToMany(targetEntity="SitioPatrimonial", mappedBy="categoria")
     */
    ...
    public function addSitiopatrimonial(SitioPatrimonial $sitiopatrimonial): self
    {
        if (!$this->sitiopatrimonial->contains($sitiopatrimonial)) {
            ...
            $sitiopatrimonial->setCategoria($this);
        }
    ...
    public function removeSitiopatrimonial(SitioPatrimonial $sitiopatrimonial): self
    {
        if ($this->sitiopatrimonial->contains($sitiopatrimonial)) {
            ...
            if ($sitiopatrimonial->getCategoria() === $this) {
                $sitiopatrimonial->setCategoria(null);
            }
        }
