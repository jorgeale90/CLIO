...
/**
 * @ORM\Table(name="referenciaweb")
 * @ORM\Entity(repositoryClass="App\Repository\ReferenciaWebRepository")
 */
...
class ReferenciaWeb
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="SitioPatrimonial", inversedBy="referenciaweb")
