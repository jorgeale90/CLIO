...
/**
 * @ORM\Entity(repositoryClass="App\Repository\ContextoRepository")
 * @UniqueEntity(fields={"nombre"}, message="Ya existe este Contexto.")
 * @Auditable()
 */
...
class Contexto
{
    ...
    /**
     * @var string
     * @ORM\Column(name="nombrecont", type="string",  nullable=false, length=80, unique=true)
    ...
    /**
     * @ORM\OneToMany(targetEntity="SitioPatrimonial", mappedBy="contexto")
     */
    ...
    public function addSitiopatrimonial(SitioPatrimonial $sitiopatrimonial): self
    {
        if (!$this->sitiopatrimonial->contains($sitiopatrimonial)) {
            ...
            $sitiopatrimonial->setContexto($this);
        }
    ...
    public function removeSitiopatrimonial(SitioPatrimonial $sitiopatrimonial): self
    {
        if ($this->sitiopatrimonial->contains($sitiopatrimonial)) {
            ...
            if ($sitiopatrimonial->getContexto() === $this) {
                $sitiopatrimonial->setContexto(null);
            }
        }
