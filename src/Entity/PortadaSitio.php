...
/**
 * @ORM\Table(name="portadasitio")
 * @ORM\Entity(repositoryClass="App\Repository\PortadaSitioRepository")
 */
...
class PortadaSitio
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="SitioPatrimonial", inversedBy="portadasitio")
