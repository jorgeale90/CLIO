...
class Profesion
{
    ...
    /**
     * @var string
     * @ORM\Column(name="nombreprofes", type="string",  nullable=false, length=80, unique=true)
    ...
    /**
     * @ORM\OneToMany(targetEntity="App\Entity\Especialista", mappedBy="profesion")
     */
    ...
    public function addEspecialista(Especialista $especialista): self
    {
        if (!$this->especialistas->contains($especialista)) {
            ...
            $especialista->setProfesion($this);
        }
    ...
    public function removeEspecialista(Especialista $especialista): self
    {
        if ($this->especialistas->contains($especialista)) {
            ...
            if ($especialista->getProfesion() === $this) {
                $especialista->setProfesion(null);
            }
        }
