...
class CategoriaCientifica
{
    ...
    /**
     * @var string
     * @ORM\Column(name="nombrecategoriacien", type="string",  nullable=false, length=80, unique=true)
    ...
    /**
     * @ORM\OneToMany(targetEntity="App\Entity\Especialista", mappedBy="categoriacientifica")
     */
    ...
    public function addEspecialista(Especialista $especialista): self
    {
        if (!$this->especialistas->contains($especialista)) {
            ...
            $especialista->setCategoriacientifica($this);
        }
    ...
    public function removeEspecialista(Especialista $especialista): self
    {
        if ($this->especialistas->contains($especialista)) {
            ...
            if ($especialista->getCategoriacientifica() === $this) {
                $especialista->setCategoriacientifica(null);
            }
        }
