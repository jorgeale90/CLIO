...
/**
 * @ORM\Table(name="bibliografias")
 * @ORM\Entity(repositoryClass="App\Repository\BibliografiasRepository")
 */
...
class Bibliografias
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="SitioPatrimonial", inversedBy="bibliografia")
