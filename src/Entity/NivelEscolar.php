...
/**
 * @ORM\Entity(repositoryClass="App\Repository\NivelEscolarRepository")
 * @UniqueEntity(fields={"nombre"}, message="Ya existe este Nivel Escolar.")
 * @Auditable()
 */
...
class NivelEscolar
{
    ...
    /**
     * @var string
     * @ORM\Column(name="nombrenivelescolar", type="string",  nullable=false, length=80, unique=true)
    ...
    /**
     * @ORM\OneToMany(targetEntity="App\Entity\Especialista", mappedBy="nivelescolar")
     */
    ...
    public function addEspecialista(Especialista $especialista): self
    {
        if (!$this->especialistas->contains($especialista)) {
            ...
            $especialista->setNivelescolar($this);
        }
    ...
    public function removeEspecialista(Especialista $especialista): self
    {
        if ($this->especialistas->contains($especialista)) {
            ...
            if ($especialista->getNivelescolar() === $this) {
                $especialista->setNivelescolar(null);
            }
        }
