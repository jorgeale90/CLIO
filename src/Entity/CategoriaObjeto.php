...
/**
 * @ORM\Entity(repositoryClass="App\Repository\CategoriaObjetoRepository")
 * @UniqueEntity(fields={"nombre"}, message="Ya existe esta Categoría de Objeto.")
 * @Auditable()
 */
...
class CategoriaObjeto
{
    ...
    /**
     * @var string
     * @ORM\Column(name="nombrecategoriaobj", type="string",  nullable=false, length=80, unique=true)
    ...
    /**
     * @ORM\OneToMany(targetEntity="FichaObjetoPatrimonial", mappedBy="categoriaobjeto")
     */
    ...
    public function addFichaobjeto(FichaObjetoPatrimonial $fichaobjeto): self
    {
        if (!$this->fichaobjeto->contains($fichaobjeto)) {
            ...
            $fichaobjeto->setCategoriaobjeto($this);
        }
    ...
    public function removeFichaobjeto(FichaObjetoPatrimonial $fichaobjeto): self
    {
        if ($this->fichaobjeto->contains($fichaobjeto)) {
            ...
            if ($fichaobjeto->getCategoriaobjeto() === $this) {
                $fichaobjeto->setCategoriaobjeto(null);
            }
        }
