...
class CategoriaDocente
{
    ...
    /**
     * @var string
     * @ORM\Column(name="nombrecategoriadoc", type="string",  nullable=false, length=80, unique=true)
    ...
    /**
     * @ORM\OneToMany(targetEntity="App\Entity\Especialista", mappedBy="categoriadocente")
     */
    ...
    public function addEspecialista(Especialista $especialista): self
    {
        if (!$this->especialistas->contains($especialista)) {
            ...
            $especialista->setCategoriadocente($this);
        }
    ...
    public function removeEspecialista(Especialista $especialista): self
    {
        if ($this->especialistas->contains($especialista)) {
            ...
            if ($especialista->getCategoriadocente() === $this) {
                $especialista->setCategoriadocente(null);
            }
        }
