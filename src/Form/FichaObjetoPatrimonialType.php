...
class FichaObjetoPatrimonialType extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add('sitiopatrimonial', EntityType::class, array(
                ...
                'query_builder' => function (SitioPatrimonialRepository $em) {
            ...
            ->add('descripcion_tecnica', CKEditorType::class, array(
                'config_name' => 'main_config3',
            ))

            ->add('descripcion_visual', CKEditorType::class, array(
                'config_name' => 'main_config3',
            ))
            ...
            ->add('hecho_historico_relacionado', CKEditorType::class, array(
                'config_name' => 'main_config3',
            ))
            ...
            ->add('lugares_exposicion', CKEditorType::class, array(
                'config_name' => 'main_config3',
            ))
            ...
            ->add('portadaobjeto', FileType::class, [
                'label' => false,
                'multiple' => true,
                'mapped' => false,
                'required' => false
