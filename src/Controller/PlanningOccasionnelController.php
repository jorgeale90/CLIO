...
/**
 * @Route("/user/planningoccasionnel")
 */
class PlanningOccasionnelController extends AbstractController
{
    /**
     * @Route("/", name="planningoccasionneladmin_index", methods={"GET"})
     */
    ...
    /**
     * @Route("/index", name="planningoccasionnel_index", methods={"GET"})
     */
    ...
    /**
     * @Route("/new", name="planningoccasionnel_new", methods={"GET","POST"})
     */
    ...
    /**
     * @Route("/edit", name="planningoccasionnel_edit", methods={"GET","POST"})
     */
    ...
    /**
     * @Route("planningoccasionnel/remove", name="removerplanningoccasionnel")
     */
